    ...
    Blog.find()
        .then(data => {
            ...
            const modifiedData = data.map(item => {
                const imageUrl = (item.ImageUniqueName == null) ? null : ImgUrl + `/uploads/blogImages/${item.ImageUniqueName}`;
    ...
    Blog.findById(id)
        .then(data => {
            ...
            if (!data) {
                ...
                data.ImageURL = (data.ImageUniqueName == null) ? null : ImgUrl + `/uploads/blogImages/${data.ImageUniqueName}`;
